...
REPO_URL="${REPO_URL:-$(prompt "GitHub repo URL репозитория" "https://github.com/vanechka1989/club.git")}"
...
DEPLOY_DIR="${DEPLOY_DIR:-$(prompt "Папка установки на сервере" "/opt/telegram-club")}"
