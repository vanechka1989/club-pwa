...
const productMapping = readFileSync(resolve(process.cwd(), "src/payments/productMapping.ts"), "utf8");
...
describe("optional payment product badge", () => {
  it("persists and returns a nullable badge label", () => {
    ...
    expect(productMapping).toContain("badgeLabel: product.badgeLabel");
