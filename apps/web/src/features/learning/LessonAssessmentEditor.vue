...
<style scoped>
.assessment-editor{display:grid;gap:14px;padding:16px;border:1px solid color-mix(in srgb,var(--accent) 24%,var(--border));border-radius:22px;background:var(--surface-2);color:var(--text)}.assessment-editor__header{display:flex;gap:12px;align-items:center}.assessment-editor__header>div{display:grid;gap:3px}.assessment-editor__header small,.assessment-options>small{color:var(--muted)}.assessment-editor__icon{display:grid;place-items:center;width:42px;height:42px;border-radius:14px;color:var(--accent);background:var(--accent-soft)}.assessment-editor__icon svg,.assessment-editor__modes svg,.assessment-editor__add svg,.assessment-question button svg{width:18px;height:18px}.assessment-editor__modes{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.assessment-editor__modes button{display:flex;min-height:48px;gap:7px;align-items:center;justify-content:center;padding:9px;border:1px solid var(--border);border-radius:15px;color:var(--muted-strong);background:var(--surface-3);font-weight:700}.assessment-editor__modes button.active{border-color:var(--accent);color:var(--accent-text);background:var(--accent)}.assessment-editor__body,.assessment-editor__body label{display:grid;gap:7px}.assessment-editor__numbers,.assessment-question__row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.assessment-question{display:grid;gap:12px;padding:14px;border:1px solid var(--border);border-radius:18px;background:var(--surface-3)}.assessment-question>header,.assessment-option{display:flex;gap:9px;align-items:center}.assessment-question>header{justify-content:space-between}.assessment-question button,.assessment-option button{display:grid;place-items:center;min-width:38px;height:38px;border:0;border-radius:12px;color:var(--danger-text);background:var(--danger-soft)}.assessment-options{display:grid;gap:9px}.assessment-option>.text-input{flex:1}.assessment-option>input:first-child{width:20px;height:20px;accent-color:var(--accent)}.assessment-editor__add{display:flex;align-items:center;justify-content:center;gap:7px;min-height:44px;border:1px dashed color-mix(in srgb,var(--accent) 45%,var(--border));border-radius:14px;color:var(--accent);background:var(--accent-soft);font-weight:800}.assessment-editor__add--primary{border-style:solid}.assessment-homework-methods{display:flex;flex-wrap:wrap;gap:9px}.assessment-homework-methods label{display:flex;grid-auto-flow:column;align-items:center;gap:8px;padding:11px 13px;border:1px solid var(--border);border-radius:13px;background:var(--surface-3)}.assessment-homework-methods input{width:19px;height:19px;accent-color:var(--accent)}@media(max-width:540px){.assessment-editor__modes{grid-template-columns:1fr}.assessment-editor__numbers,.assessment-question__row{grid-template-columns:1fr}}
</style>
