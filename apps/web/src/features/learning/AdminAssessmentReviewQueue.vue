...
<style scoped>
.review-queue{display:grid;gap:10px;padding:15px;border:1px solid rgba(45,220,185,.22);border-radius:22px;background:rgba(5,47,40,.72)}.review-queue>header,.review-queue>header>div{display:flex;align-items:center;justify-content:space-between;gap:11px}.review-queue>header>div>span{display:grid;place-items:center;width:42px;height:42px;border-radius:14px;color:#25dbb7;background:rgba(37,219,183,.12)}.review-queue>header>div>div,.review-queue__entry>span{display:grid;gap:3px}.review-queue small,.review-queue__muted{color:#9db7b0}.review-queue>header b{display:grid;place-items:center;min-width:31px;height:31px;border-radius:999px;color:#062f28;background:#2cddb9}.review-queue__entry{display:flex;align-items:center;justify-content:space-between;padding:13px;border:1px solid rgba(255,255,255,.09);border-radius:15px;color:inherit;text-align:left;background:rgba(255,255,255,.025)}.review-queue__entry>svg{width:19px;color:#24dcb7}.review-queue__error{color:#ff8d95}.review-sheet{position:fixed;z-index:1000;inset:0;display:flex;align-items:flex-end;justify-content:center;padding-top:60px;background:rgba(0,15,12,.72);backdrop-filter:blur(8px)}.review-sheet__panel{display:grid;gap:13px;width:min(620px,100%);max-height:calc(100dvh - 60px);padding:19px;overflow:auto;border:1px solid rgba(77,228,198,.25);border-radius:26px 26px 0 0;background:#073d34}.review-sheet__panel>header{display:flex;align-items:center;justify-content:space-between}.review-sheet__panel>header>div{display:grid;gap:3px}.review-sheet__panel>header button{display:grid;place-items:center;width:42px;height:42px;border:1px solid rgba(255,255,255,.11);border-radius:14px;color:#d9e6e2;background:transparent}.review-sheet__answer,.review-sheet__question{padding:14px;border:1px solid rgba(255,255,255,.09);border-radius:15px;background:rgba(0,0,0,.12);line-height:1.55}.review-sheet__file{padding:12px;border-radius:13px;color:#38deb9;background:rgba(36,218,181,.08)}.review-sheet__question{display:grid;gap:9px}.review-sheet__question p{margin:0}.review-sheet__question label,.review-sheet__comment{display:grid;gap:6px}.review-sheet__actions{display:grid;grid-template-columns:1fr 1fr;gap:9px}.review-sheet__actions button,.review-sheet__accept--wide{display:flex;min-height:50px;align-items:center;justify-content:center;gap:8px;border:0;border-radius:15px;font-weight:850}.review-sheet__actions svg,.review-sheet__accept--wide svg{width:19px}.review-sheet__revision{color:#ff9298;background:rgba(255,101,112,.13)}.review-sheet__accept{color:#062f28;background:#2cddb9}.review-sheet__accept--wide{width:100%}.review-sheet button:disabled{opacity:.45}
</style>
