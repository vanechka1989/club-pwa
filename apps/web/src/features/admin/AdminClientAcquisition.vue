...
import { Route, Tags } from "lucide-vue-next";
...
<template>
  <section class="client-acquisition admin-detail ui-card" aria-labelledby="client-acquisition-title">
    ...
    <div v-else-if="source" class="client-acquisition-body">
      <article class="client-acquisition-source">
      ...
      <dl class="client-acquisition-utm" aria-label="UTM-метки клиента">
        <div><dt>utm_source</dt><dd>{{ source.source }}</dd></div>
        <div><dt>utm_medium</dt><dd>{{ source.medium }}</dd></div>
        <div><dt>utm_campaign</dt><dd>{{ source.campaign }}</dd></div>
...
<style scoped>
.client-acquisition{padding:0;overflow:hidden}.client-acquisition-head{display:flex;align-items:center;gap:10px;padding:15px;border-bottom:1px solid var(--border)}.client-acquisition-head>span,.client-acquisition-source>span{width:36px;height:36px;flex:0 0 auto;border-radius:12px;display:grid;place-items:center;background:color-mix(in srgb,var(--accent) 16%,transparent);color:var(--accent)}.client-acquisition-head svg,.client-acquisition-source svg{width:18px}.client-acquisition-head div{min-width:0;display:grid;gap:2px}.client-acquisition-head b{font-size:14px}.client-acquisition-head small{font-size:10px;color:var(--muted)}.client-acquisition-body{display:grid;gap:12px;padding:14px}.client-acquisition-source{display:flex;align-items:center;gap:10px;padding:12px;border-radius:14px;background:var(--surface-soft)}.client-acquisition-source div{min-width:0;display:grid;gap:2px}.client-acquisition-source small{font-size:10px;color:var(--muted)}.client-acquisition-source strong{font-size:16px;overflow-wrap:anywhere}.client-acquisition-utm{display:grid;margin:0;border:1px solid var(--border);border-radius:14px;overflow:hidden}.client-acquisition-utm>div{display:grid;grid-template-columns:minmax(92px,.7fr) minmax(0,1.3fr);gap:10px;align-items:start;padding:11px 12px}.client-acquisition-utm>div+div{border-top:1px solid var(--border)}.client-acquisition-utm dt{font-size:10px;color:var(--muted)}.client-acquisition-utm dd{min-width:0;margin:0;font-size:11px;font-weight:800;text-align:right;overflow-wrap:anywhere}.client-acquisition-empty{margin:0;padding:14px;color:var(--muted);font-size:11px}
