...
<template>
  <div class="individual-offer-entry">
    <button class="individual-offer-button ui-button" type="button" :disabled="disabled" @click="show"><Gift aria-hidden="true" />Выдать подписку</button>
    <Teleport to="body">
