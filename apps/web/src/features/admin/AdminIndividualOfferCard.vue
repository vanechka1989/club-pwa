...
<template>
  <div class="individual-offer-entry">
    <button class="individual-offer-button ui-button" type="button" :disabled="disabled" @click="show"><Banknote aria-hidden="true" /><span>Индивидуальная подписка</span></button>
    <Teleport to="body">
