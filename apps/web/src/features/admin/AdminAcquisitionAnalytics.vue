...
import { BarChart3, Check, ChevronRight, Copy, Link2, MousePointerClick, Plus, UserPlus, UsersRound, WalletCards } from "lucide-vue-next";
...
.acquisition-source-list{display:grid;gap:0;margin-top:8px}.acquisition-source-list article{display:grid;gap:6px;padding:8px 0;border-top:1px solid var(--border)}.acquisition-source-list article>header{display:flex;align-items:center;justify-content:space-between;gap:8px}.acquisition-source-list article>header strong{min-width:0}.acquisition-source-list article>header small{flex:0 0 auto;color:var(--muted);font-size:9px}.acquisition-source-metrics{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr));gap:0!important;overflow:visible!important}.acquisition-source-metrics>span{display:grid;min-width:0;gap:2px;padding:3px 5px;border-left:1px solid color-mix(in srgb,var(--border) 72%,transparent);text-align:left!important}.acquisition-source-metrics>span:first-child{padding-left:0;border-left:0}.acquisition-source-metrics small{color:var(--muted);font-size:8px;line-height:1.15}.acquisition-source-metrics b{min-width:0;font-size:11px;line-height:1.2;overflow-wrap:anywhere}
