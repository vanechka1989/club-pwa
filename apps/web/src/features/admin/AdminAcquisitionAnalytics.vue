...
.acquisition-chart-scroll{min-height:128px;gap:10px}.acquisition-chart-day{min-width:42px}.acquisition-chart-values{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:2px;font-size:10px;line-height:1}.acquisition-chart-values b{min-width:12px;font-weight:900;text-align:center}.value-visits{color:var(--accent)}.value-regs{color:#78b2ff}.value-paid{color:#c99aff}
