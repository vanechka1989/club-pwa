...
<style scoped>
.ops-panel{display:grid;gap:16px}.ops-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.ops-head>div{min-width:0;flex:1}.ops-head h3{margin:0;font-size:1.25rem}.ops-head p{margin:4px 0 0;color:var(--muted)}.ops-button{flex:none;min-height:44px;padding:0 16px;border:1px solid var(--border);border-radius:14px;background:var(--surface-strong);color:var(--text);font:inherit;font-weight:700;white-space:nowrap}.ops-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.ops-summary article{display:grid;gap:4px;padding:14px;border:1px solid var(--border);border-radius:16px;background:var(--surface)}.ops-summary span,.payment-card small,.payment-card p,.payment-meta{color:var(--muted)}.ops-summary strong{font-size:1.35rem}.good strong{color:var(--success,#28c98b)}.warn strong{color:#d8a92f}.bad strong{color:#e87979}.ops-list{display:grid;gap:10px}.payment-card{display:grid;gap:10px;padding:16px;border:1px solid var(--border);border-radius:18px;background:var(--surface)}.payment-top{display:flex;align-items:flex-start;justify-content:space-between;gap:10px}.payment-top>div{display:grid;gap:4px;min-width:0}.payment-top em{flex:none;padding:6px 9px;border-radius:999px;font-size:.78rem;font-style:normal;font-weight:800}.severity-success{color:#52d8a7;background:rgba(39,181,130,.14)}.severity-info{color:var(--accent);background:color-mix(in srgb,var(--accent) 14%,transparent)}.severity-warning{color:#e0b541;background:rgba(224,181,65,.14)}.severity-danger{color:#ff8e8e;background:rgba(220,75,75,.15)}.payment-card p{margin:0}.payment-meta{display:flex;flex-wrap:wrap;gap:6px 12px;font-size:.82rem}.payment-id{overflow-wrap:anywhere}.ops-error{margin:0;padding:12px;border-radius:14px;color:#ff9a9a;background:rgba(190,50,50,.13)}.ops-empty{text-align:center;color:var(--muted)}@media(max-width:420px){.ops-summary{grid-template-columns:repeat(2,minmax(0,1fr))}.payment-top{align-items:flex-start}.payment-top em{max-width:44%;text-align:center}}@media(max-width:340px){.ops-head{display:grid}.ops-button{width:100%}}
</style>
