...
import { Activity, BookOpen, ChevronRight, CircleDollarSign, Copy, CreditCard, Lock, LockOpen, MessageCircle, MessageCircleOff, Network, Paperclip, ShieldAlert, SlidersHorizontal, Smartphone, UserRoundPlus, X } from "lucide-vue-next";
