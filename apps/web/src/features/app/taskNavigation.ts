...
export const taskRoutePaths = [
  ...
  "/admin/clients/:customerId/payments",
  "/admin/clients/:customerId/referrals",
  "/admin/clients/:customerId/moderation",
  "/admin/clients/:customerId/devices",
  "/admin/clients/:customerId/login-ips",
  "/admin/clients/:customerId/learning/:mode/:recordId",
