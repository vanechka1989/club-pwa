...
export const currentRelease = {
  version: "5.68",
  updatedAt: "27.07.2026 00:26",
  title: "Оптимизация кода и загрузки",
  items: [
    "Удалены недостижимые старые экраны и неиспользуемый код без изменения рабочих функций.",
    "API-контейнер теперь получает только production-зависимости, а лишняя библиотека S3 удалена.",
    "Стили вкладок и история обновлений разделены безопаснее; стартовая загрузка и сопровождение стали легче."
  ]
} as const;
