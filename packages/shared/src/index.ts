...
export const currentRelease = {
  version: "5.70",
  updatedAt: "27.07.2026 08:12",
  title: "Надёжные цены Lava и раздельная статистика",
  items: [
    "Каталог Lava корректно сохраняет цены каждой валюты отдельно для месячного, 90-дневного, 180-дневного и годового периода.",
    "Редактор тарифа автоматически подставляет актуальные суммы выбранного периода, сохраняет включённые валюты и показывает их компактными строками.",
    "Показатели поддержки теперь разделены на четыре самостоятельные карточки, а сервер проверяет цену Lava именно для периода оплачиваемого тарифа."
  ]
} as const;
