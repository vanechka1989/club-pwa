...
export const currentRelease = {
  version: "5.69",
  updatedAt: "27.07.2026 04:40",
  title: "Оплата в рублях, евро и долларах",
  items: [
    "Для тарифов Lava Top администратор может включить цены в рублях, евро и долларах.",
    "Перед оплатой клиент выбирает одну из доступных валют, а сумма всегда проверяется сервером.",
    "Webhook и сверка платежей учитывают точную сумму и валюту; административные разделы стали легче и быстрее."
  ]
} as const;
